describe('Hospital', () => {
  beforeEach(() => {
    cy.visit('https://weaakash-me-fe-xmedify-v2-5js41cjxb.vercel.app'); // Updated to new deployment URL
  });
  ...
  it('should display all booked slots on the My Bookings page', () => {
    ...
    cy.visit('https://weaakash-me-fe-xmedify-v2-5js41cjxb.vercel.app/my-bookings'); // Updated to new deployment URL
